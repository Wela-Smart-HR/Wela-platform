...
import { House, Clock, CalendarCheck, Wallet, User } from '@phosphor-icons/react';
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-100 flex justify-center font-sans pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="w-full max-w-[480px] bg-[#FAFAFA] h-screen relative shadow-2xl overflow-hidden flex flex-col border-x border-slate-200">
        ...
        {/* 4. แถบบาร์ลอยตัว */}
        {/* ⚠️ เปลี่ยนจาก fixed -> absolute เพื่อให้บาร์ติดอยู่กับท้าย "กรอบมือถือ" ไม่ใช่ท้าย "จอคอม" */}
        <div className="absolute bottom-8 left-0 right-0 z-50 flex justify-center pointer-events-none">
          
          <div className="animate-slide-up-bar pointer-events-auto bg-blue-600 shadow-2xl shadow-blue-600/30 rounded-full px-2 py-2 flex items-center justify-center gap-2 transition-all ring-4 ring-white/30 backdrop-blur-md">
